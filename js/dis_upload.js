...
disUpload.prototype = {
	upSelect:function(cmd){
		...
		var value = ["拍照Upload ","本地Upload "];
		uexWindow.actionSheet('', 'Cancel', value);
	},
...
function cbCreateUploader(opCode, dataType, data) {
	...
	if (Int(data) == 0) {
		...
		uexWindow.toast('0', '5', "Upload  Failed", 2000);
